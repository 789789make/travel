<template>
	<div class="weekend">
		...
		<ul>
			<li class="weekend-item border-bottom" v-for='item in weekendList' :key='item.id'>
				<div class="item-img">
